export function MethodologyView() {
  return (
    <div className="card method">
      ...
      <div className="m-ind"><span className="tag">A</span><strong>Iepirkumu sadalīšana.</strong> Vairāki slieksnim tuvi līgumi vienā CPV grupā īsā laika logā (90 dienas), kas katrs paliek zem procedūras sliekšņa, bet kopā to pārsniedz. Slieksni izvēlamies pēc <strong>piemērotā likuma</strong>: Publisko iepirkumu likums (PIL) — preces un pakalpojumi 42 000 €, būvdarbi 170 000 €; Sabiedrisko pakalpojumu sniedzēju iepirkumu likums (SPSIL, piem. enerģētika, ūdens, transports, ostas) — preces un pakalpojumi 428 000 €, būvdarbi 5 350 000 €. Tas novērš viltus signālus tur, kur likumīgais slieksnis ir augstāks. Sarkans, ja ir ≥4 līgumi, viens uzvarētājs vai kopsumma &gt;1,5× slieksnis. Piemērotais likums tiek noteikts no paziņojuma juridiskā pamata (kur tas norādīts); ja nav zināms, konservatīvi lietojam PIL slieksni.</div>
